...
def get_train_utility_results_dir(args):
    save_path = ''
    if args.graph_type == "Grid_Graph":
        save_path = './data/pretrain_models/grasper_mappo/grid_{}_probability_{}/utility_record'.format(
            args.row * args.column, args.edge_probability)
    elif args.graph_type == 'SG_Graph':
        save_path = f'./data/pretrain_models/grasper_mappo/sg_graph_probability_{args.edge_probability}/utility_record'
    elif args.graph_typee == 'SY_Graph':
        save_path = f'./data/pretrain_models/grasper_mappo/sy_graph/utility_record'
    elif args.graph_type == 'SF_Graph':
        save_path = f'./data/pretrain_models/grasper_mappo/sf_graph_{args.sf_sw_node_num}/utility_record'
    if args.use_end_to_end:
        save_path += "/use_e2e"
    else:
        save_path += "/not_e2e"
...
def get_runs_dir(args):
    location = ""
    if args.graph_type == "Grid_Graph":
        location = "grasper_mappo_grid_{}_probability_{}"\
            .format(args.row * args.column, args.edge_probability)
    elif args.graph_type == 'SG_Graph':
        location = f"grasper_mappo_sg_graph_probability_{args.edge_probability}"
    elif args.graph_type == 'SY_Graph':
        location = f"grasper_mappo_sy_graph"
    elif args.graph_type == 'SF_Graph':
        location = f"grasper_mappo_sf_graph_{args.sf_sw_node_num}"
    location += "_seed{}_num_gts{}_{}_{}_bsize{}_node_feat{}_gnn{}_{}_{}_dnum{}_enum{}_T{}_{}_mep{}" \
        .format(args.seed, args.num_games, args.num_task, args.num_sample, args.batch_size, args.node_feat_dim,
                args.gnn_num_layer, args.gnn_hidden_dim, args.gnn_output_dim, args.num_defender,
                args.num_exit, args.min_time_horizon, args.max_time_horizon, args.min_evader_pth_len)
