...
from mappo.utils.util import get_gard_norm, huber_loss
...
class RMAPPO:
    ...
    def ppo_update(self, sample, update_actor=True):
        pooled_node_embs_batch, Ts_batch, share_obs_batch, obs_batch, actions_batch, value_preds_batch, return_batch, masks_batch, old_action_log_probs_batch, adv_targ, demo_act_probs_batch = sample
        values, action_log_probs, dist_entropy, log_probs = self.policy.evaluate_actions(share_obs_batch, obs_batch, actions_batch, pooled_node_embs_batch, Ts_batch, batch=True)
